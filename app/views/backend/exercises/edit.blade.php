...
@section('content')
		{{ Form::open(['route' => ['subjects.exercises.update', $subject->id, $exercise->id], 'method' => 'put']) }}
			<div class="form-group">
				{{ Form::label('exercise_name', 'Exercise:') }} <br>
				{{ Form::text('exercise_name', $exercise->exercise_name , ['placeholder' => 'Exercise name', 'class' => 'form-input']) }} <br>
			...
			<div class="form-group">
				...
				{{ Form::textarea('exercise_description', $exercise->exercise_description, ['placeholder' => 'Exercise description', 'class' => 'form-input']) }} <br>
