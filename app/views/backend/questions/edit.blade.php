...
@section('content')
		{{ Form::open(['route' => ['subjects.exercises.questions.update', $subject_id, $exercise->id, $question->id], 'method' => 'put', 'files' => true]) }}
			<div class="form-group">
				{{ Form::label('question_text', 'Question:') }} <br>
				{{ Form::textarea('question_text', $question->question_text, ['placeholder' => 'Question', 'class' => 'form-input']) }} <br>
			...
			<div class="form-group">
				...
				{{ Form::textarea('answer_text_1', $correct_answer->answer_text, ['placeholder' => 'Answer 1', 'class' => 'form-input']) }} <br>
				{{ $errors->first('answer_text_1', '<span class="error">:message</span> ') }}
			</div>
			<div class="form-group">
				{{ Form::label('answer_text_2', 'Answer:') }} <br>
				{{ Form::textarea('answer_text_2', $other_answer_1->answer_text, ['placeholder' => 'Answer 2', 'class' => 'form-input']) }} <br>
